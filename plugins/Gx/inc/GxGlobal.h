...
#define SUB_TYPE_MSISDN				0
#define SUB_TYPE_IMSI				1

#define USER_EQUIPMENT_IMEI			0

/*CLEAN UP TYPES*/

typedef struct _GxGySession{
	uint16_t	flushType;
	...
	_GxGySession(const _GxGySession& obj)
	{
	...
	void copy(const _GxGySession* obj)
	{
		this->flushType 				= obj->flushType;
		this->StartTimeEpochMiliSec 	= obj->StartTimeEpochMiliSec;
		this->EndTimeEpochMiliSec 		= obj->EndTimeEpochMiliSec;
...
namespace GX_AVP
{
	extern std::map<uint16_t, avpType> gxAVPType;
}

namespace GXSMStore
{
	extern std::unordered_map<int, DiameterBody> gx_msg_sm_i_r_t[MAX_SESSION_MANAGER_SUPPORT][MAX_INTERFACE_SUPPORT][MAX_ROUTER_PER_INTERFACE_SUPPORT][10];
	extern bool gx_msg_busy_sm_i_r_t[MAX_SESSION_MANAGER_SUPPORT][MAX_INTERFACE_SUPPORT][MAX_ROUTER_PER_INTERFACE_SUPPORT][10];
	extern int gx_msg_cnt_sm_i_r_t[MAX_SESSION_MANAGER_SUPPORT][MAX_INTERFACE_SUPPORT][MAX_ROUTER_PER_INTERFACE_SUPPORT][10];
}

namespace GXFlusher
{
	extern std::unordered_map<int, gxgySession> gxFlushMap_sm_t[MAX_SESSION_MANAGER_SUPPORT][10];
	extern bool gxFlushMap_busy_sm_t[MAX_SESSION_MANAGER_SUPPORT][10];
	extern int gxFlushMap_cnt_sm_t[MAX_SESSION_MANAGER_SUPPORT][10];
}

namespace GXXdrWriter
{
	extern std::unordered_map<int, xdrStore> gxXdrMap_t[10];
	extern bool gxXdrMap_busy_t[10];
	extern int gxXdrMap_cnt_t[10];
}
