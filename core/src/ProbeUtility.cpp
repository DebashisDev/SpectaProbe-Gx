...
VOID
ProbeUtility::ExtractIP4Address(const BYTE packet, char *ipBuffer, uint32_t loc)
{
...
VOID
ProbeUtility::ExtractIP6Address(const UCHAR *packet, char *ipBuffer, uint32_t loc)
{
...
VOID
ProbeUtility::ExtractIP6Prefix(const UCHAR *packet, char *ipBuffer, uint32_t start, uint32_t end)
{
	ipBuffer[0] = 0;
